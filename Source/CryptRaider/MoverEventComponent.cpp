...
#include "MoverEventComponent.h"
#include "Math/UnrealMathUtility.h"

// Sets default values for this component's properties
UMoverEventComponent::UMoverEventComponent()
{
...
void UMoverEventComponent::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void UMoverEventComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
